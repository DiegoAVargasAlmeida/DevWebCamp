<?php include_once __DIR__ . '/workshops-conferencias.php' ?>
        ...
        <?php foreach ($ponentes as $ponente) { ?>
            ...
            <div data-aos="<?php aos_animacion();?>" class="speaker">
                <picture class="evento__imagen">
                    ...
                    <img class="speaker__imagen" width="200" height="300" src="img/speakers/<?php echo  $ponente->imagen; ?>.png" alt="Imagen ponente">
